...
Writes training/bench_results_v2.json for presentation."""
...
MODELS = [
    ("qwen05b", "Qwen/Qwen2.5-0.5B-Instruct", os.path.join(HERE, "adapters/qwen05b_v2")),
    ("llama1b", "unsloth/Llama-3.2-1B-Instruct", os.path.join(HERE, "adapters/llama1b_v2")),
]
...
json.dump(results, open(os.path.join(HERE, "bench_results_v2.json"), "w"), indent=2)
print("wrote bench_results_v2.json for", len(results), "held-out examples")
